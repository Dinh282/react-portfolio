...
export default function About() {
  return (
    <AnimatedPage>
      <div className="flex flex-col justify-center text-black items-center space-y-4 mx-auto w-[80%]">
        <h1 className="text-4xl dark:text-white underline decoration-1 py-4">
          About Me
        </h1>
        ...
        <p className="pb-1 text-lg dark:text-white">
        ...
        <p className="pb-5 text-lg dark:text-white">
